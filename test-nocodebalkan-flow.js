...
const testEmail = `nocodebalkan-${Date.now()}@example.com`
const testPassword = 'test123456'

async function testNocodebalkanFlow() {
  console.log('🚀 Počinjem test celog flow-a sa nocodebalkan.com...')
  console.log(`📧 Test email: ${testEmail}`)
  console.log(`🌐 Test website: https://nocodebalkan.com/`)
  ...
  try {
    ...
    const { error: brainError } = await supabase
      ...
      .insert({
        ...
        company_name: 'NoCode Balkan',
        industry: 'Technology/No-Code',
        goals: ['Increase brand awareness', 'Grow community', 'Generate leads'],
        website: 'https://nocodebalkan.com/',
        data: {
          team_size: '1-5',
          monthly_revenue: '5k-20k',
    ...
    try {
      ...
      if (perplexityResponse.ok) {
        ...
        console.log('📝 Prvih 200 karaktera:', websiteSummary.substring(0, 200) + '...')
        
        // 4. TESTIRAJ OPENAI API SA PERPLEXITY PODACIMA
        console.log('\n4️⃣ Testiram OpenAI API sa Perplexity podacima...')
        
        const onboardingData = `
          Naziv kompanije: NoCode Balkan
          Industrija: Technology/No-Code
          Ciljevi: Increase brand awareness, Grow community, Generate leads
          Veličina tima: 1-5
          Mesečni prihodi: 5k-20k
        ...
        if (openaiResponse.ok) {
          ...
          console.log('📝 Prvih 200 karaktera:', analysis.substring(0, 200) + '...')
    ...
    console.log(`🌐 Website: https://nocodebalkan.com/`)
