...
// Test email
const testEmail = `tialorens-improved-${Date.now()}@example.com`
const testPassword = 'test123456'

async function testTialorensImproved() {
  console.log('🚀 Počinjem poboljšani test sa tialorens.rs...')
  ...
  try {
    ...
    // 3. TESTIRAJ PERPLEXITY API SA POBOLJŠANIM PROMPTOM
    console.log('\n3️⃣ Testiram Perplexity API sa poboljšanim promptom...')
    try {
      const perplexityPrompt = `Analyze the website https://tialorens.rs/ and provide detailed business information. Focus on:
      1. What type of business this is
      2. What products/services they offer
      3. Target audience
      4. Brand positioning
      5. Key features of their website
      6. Any unique selling points
      
      Please provide a comprehensive analysis based on what you can observe from the website.`
      ...
      if (perplexityResponse.ok) {
        ...
        console.log('📝 Prvih 400 karaktera:', websiteSummary.substring(0, 400) + '...')
        ...
        if (openaiResponse.ok) {
          ...
          console.log('📝 Prvih 400 karaktera:', analysis.substring(0, 400) + '...')
